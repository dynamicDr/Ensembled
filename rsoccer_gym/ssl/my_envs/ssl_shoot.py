...
class SSLShootEnv(SSLBaseEnv):
    ...
    def _frame_to_observations(self):
        ...
        if nearest_blue_robot_dist <= nearest_yellow_robot_dist:
            if nearest_blue_robot_dist <= threshold and self.frame.robots_blue[nearest_blue_robot].dribbler is True:
                self.possession_robot_idx = nearest_blue_robot
        else:
            if nearest_yellow_robot_dist <= threshold and self.frame.robots_yellow[nearest_blue_robot].dribbler is True:
